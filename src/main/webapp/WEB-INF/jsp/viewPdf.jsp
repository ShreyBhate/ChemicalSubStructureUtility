...
<script src="build/compatibility.js"></script>



<!-- This snippet is used in production (included from viewer.html) -->
<link rel="resource" type="application/l10n"
	href="build/locale/locale.properties">
<script src="build/l10n.js"></script>
<script src="build/pdf.js"></script>
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<%@taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
<script src="build/viewer1.js"></script>
...
<div id="mainDiv" tabindex="1" class="loadingInProgress">
	<div id="outerContainer">
		...
		<div id="mainContainer">
			...
			<div id="secondaryToolbar"
				...
				<div id="secondaryToolbarButtonContainer" style="display: none">
					...
					<button id="documentProperties"
						...
						title="Document Propertiesâ¦" tabindex="61"
					...
					<div id="toolbarViewer">
						<div id="toolbarViewerLeft">
							<button id="sidebarToggle" class="toolbarButton"
								...
								data-l10n-id="toggle_sidebar" style="display: none">
								<span data-l10n-id="toggle_sidebar_label">Toggle Sidebar</span>
							</button>
							<div class="toolbarButtonSpacer"></div>
							<button id="viewFind" class="toolbarButton group hiddenSmallView"
								title="Find in Document" tabindex="12" style="display: none"
							...
							<input style="display: none" type="number" id="pageNumber"
								class="toolbarField pageNumber" title="Page" value="1" size="4"
								min="1" max="1" tabindex="15" data-l10n-id="page"> <span
								id="numPages" class="toolbarLabel" style="display: none"></span>
						</div>
						...
						<div id="toolbarViewerMiddle">
							<div class="splitToolbarButton">
								...
								<button id="zoomIn" class="toolbarButton zoomIn" title="Zoom In"
									tabindex="22" data-l10n-id="zoom_in" style="display: none">
...
<div id="transDiv" tabindex="1" class="loadingInProgress">
	
</div>
<%String Patent=request.getParameter("PatentNo"); %>
<% %>
<script type="text/javascript">

// Path - FormulationsFormulationTranslationFolder
 var c="images/Choudhary_et_al-2005-Chemistry_&_Biodiversity.pdf"; 
// Path - For Indexing - test module
 /* var c="/pdf/patent-translation/"+x+".pdf";  */
